<template>
  ...
  <div class="container announcement-section">
    ...
    <DataTableWithPagination :data="announcementInfo" :columns="tableColumns" :actions="tableActions"
...
const fetchStatistics = async () => {
  ...
  if (companyRes.code === 1 && Array.isArray(companyRes.data)) {
    companyOption.value = {
      ...
      series: [{
        name: '学生去向', type: 'pie', radius: '50%',
        data: companyRes.data.map(item => ({ value: item.studentCount, name: item.companyName })),
